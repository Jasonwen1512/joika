...
image: new URL(
      ...
      import.meta.url
    ).href,     content:'走進這間藏身巷弄的老屋餐廳，像是穿越了時光隧道。斑駁的木門輕輕推開，陽光從窗櫺灑落，斑駁光影在桌面上跳動，像是在講述一段被時間遺忘的故事。座位旁擺放著老式收音機和幾本泛黃的書籍，空氣中混合著淡淡的咖啡香與陳年的木頭味。這裡的招牌手作鹹派，是一場味覺的旅行。酥脆的派皮裡包裹著溫潤的奶油和香濃的菠菜，搭配一杯微酸的黑咖啡，簡單卻滿足。作為攝影師，最愛捕捉這種光影與空間的細膩變化。旅途中偶然發現的這片靜謐，是讓心靈得以喘息的港灣。<br>若你也喜歡細細品味生活，不妨來這裡坐坐，感受老屋的溫度，聽聽時間的聲音。'
  },
  {postid:"8", 
    userid:	"M0008",
...
image:new URL(
      "../img/activity/avtivity-img/board-game.jpg",
      import.meta.url
    ).href,    content:'在西門町的桌遊咖啡廳參加了6小時的德式桌遊工作坊，真的收穫滿滿！團主阿華是資深玩家，規則講解很清楚，還會分析每個遊戲的策略重點。玩了《農家樂》、《電力公司》、《波多黎各》三款經典，每款都有不同的樂趣。同團的人都很Nice，大家互相討論策略，氣氛很棒。雖然6小時下來有點累，但學到很多，現在已經買了《農家樂》準備跟朋友玩啦！450元真的很值得'
  },
...
image: new URL(
      "../img/activity/avtivity-img/board-game.jpg",
      import.meta.url
    ).href,     content:'說是新手友善結果完全不是這樣！團主Linda雖然人很好，但同團有幾個老鳥玩家完全不給新手機會，一直用很複雜的進階技巧。我第一輪就被票出去，後面幾乎都在旁邊看戲...雖然有學到一些，但整體體驗不太好。建議團主之後可以把新手和老手分開，或是多控制一下遊戲節奏。不過KTV包廂的環境不錯，飲料零食也夠，就是遊戲體驗需要改進。'
  },
