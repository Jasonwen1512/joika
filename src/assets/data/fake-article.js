...
import ClimbingImg from '@/assets/img/events/climbing/climbing_06.jpg';
import ClimbingImg2 from '@/assets/img/events/climbing/climbing_03.jpg';
import ClimbingImg3 from '@/assets/img/events/climbing/climbing_08.jpg';
import ClimbingImg4 from '@/assets/img/events/climbing/climbing_05.jpg';
import nopicture from '@/assets/img/article/nopicture.jpg';
import beach01 from '@/assets/img/events/watersports/beach01.jpg';
import snorkeling01 from '@/assets/img/events/watersports/snorkeling01.jpg';
import sup from '@/assets/img/events/watersports/SUP.jpg';
import trace from '@/assets/img/events/watersports/trace-the-stream.jpg';
...
image: snorkeling01,     content:'這幾年台灣越來越多人對潛水有興趣，但很多初學者會在第一次下水時緊張或手忙腳亂，甚至對「自由潛水」和「水肺潛水」分不清楚。我從 2018 年開始教學生潛水課程，累積不少經驗，也觀察到新手常見的三個問題。<br>今天簡單整理一下，給想入門的你參考：<br>一、別忽略耳壓平衡淺水不代表風險低，下潛過程中若不及時做耳壓平衡，耳膜會感到刺痛甚至受傷。每下潛一公尺，請主動捏鼻子輕輕出氣。<br>二、呼吸要穩定，別憋氣很多人緊張就憋氣，其實這是最危險的反應。穩定呼吸才是安全下潛的關鍵，就算在水下感覺心跳加快，也要專注放鬆節奏。<br>三、潛伴制度一定要記得永遠不要一個人下水。即便是在岸邊練習，也需要有潛伴互相注意狀況，這是國際潛水守則中最基本的一條。<br>這篇文章是給完全沒學過但想試試的人看的，如果你也有類似問題，歡迎留言我會回覆；另外我近期會開一場「基礎淺水體驗團」，有興趣也可以預約參加。'
   ...
   {postid:"PST-000006", 
    ...
    event:"運動",
image: nopicture,     content:'研究所生活忙碌到快忘了什麼叫運動，還好這陣子朋友推薦我用 JOIKA 找運動團，意外發現每週都有固定的籃球揪團，地點就在師大體育館，超方便！一開始還有點擔心氣氛會不會太競技，但其實大家都滿有共識，屬於「能認真打、也能放鬆玩」的那種風格。報名制度也很清楚，額滿就關團，不會現場一堆人卡位。<br>這次打的是全場 5v5，隊友配合默契不錯，而且完全不會有那種「只傳給朋友」的現象，大家互傳互動滿流暢。中場休息時也會聊一下各自怎麼知道這個揪團的，才知道有不少人其實是工程師或研究員，甚至有兩個是第一次參加。蠻推薦這種半固定的揪團，適合想保持運動習慣又不想太競爭的朋友。有興趣的人可以在活動分類裡搜尋「每週籃球週五夜場」，真的值得試一次！'
  },{postid:"PST-000007", 
    userid:	"M0007",
    date:"2025/7/15 PM4:30",
    title:"午後老屋，光影與味蕾的對話",
    event:"聚餐",
image: nopicture,     content:'走進這間藏身巷弄的老屋餐廳，像是穿越了時光隧道。斑駁的木門輕輕推開，陽光從窗櫺灑落，斑駁光影在桌面上跳動，像是在講述一段被時間遺忘的故事。座位旁擺放著老式收音機和幾本泛黃的書籍，空氣中混合著淡淡的咖啡香與陳年的木頭味。這裡的招牌手作鹹派，是一場味覺的旅行。酥脆的派皮裡包裹著溫潤的奶油和香濃的菠菜，搭配一杯微酸的黑咖啡，簡單卻滿足。作為攝影師，最愛捕捉這種光影與空間的細膩變化。旅途中偶然發現的這片靜謐，是讓心靈得以喘息的港灣。<br>若你也喜歡細細品味生活，不妨來這裡坐坐，感受老屋的溫度，聽聽時間的聲音。'
  },
  {postid:"PST-000008", 
    userid:	"M0008",
...
image: nopicture,     content:'身為工程師，平常大多時間坐在電腦前，<br>這次報名了JOIKA的新手露營團，完全是想要跳脫日常，親近大自然。<br>雖然對露營一竅不通，但幸好團裡有經驗豐富的夥伴，讓我快速學會搭帳篷、整理裝備。<br>夜晚圍著營火聊天，聽著蟲鳴鳥叫，感覺整個世界都安靜了下來。第一次在戶外睡覺，雖然有點冷，但卻特別自在。還嘗試了自己生火煮泡麵，成就感滿滿。<br>這次團體裡大家都很友善，互相幫忙、分享裝備，讓新手感覺不到壓力。<br>最喜歡的是大家一起觀察星空，那片無垠的銀河，比城市裡看到的星星多上好幾倍。<br>新手露營團絕對推薦給想試試看又怕麻煩的人，JOIKA的活動安排很貼心，讓我這種小白也能輕鬆上手。期待下一次露營，再更自在地和自然相處。'
    ...
    event:"水上活動",
image: beach01,     content:'身為土生土長的台南人，長年習慣在海邊散步，這次參加JOIKA組織的淨灘活動，才真正感受到保護環境的重要性。沿著台南安平海岸線，我們一群志同道合的朋友，拿著手套和垃圾袋，仔細地將塑膠瓶、菸蒂、包裝紙等垃圾一一撿起。看著平時美麗的海岸線被這些不起眼的垃圾侵蝕，心裡不免有些沉重。作為設計師，我也在想，或許我們可以用創意來提醒更多人愛護海洋，比如設計更友善環境的包裝，或是創作宣導海洋保護的插畫。淨灘不只是撿垃圾，更是一場與大自然的對話，提醒自己從生活小事做起，才能守護我們共有的家園。很感謝JOIKA提供這樣的平台，讓台南人能凝聚力量，一起為環境盡一份力。期待未來還有更多這樣有意義的活動，一起加入吧！'
  },
      {postid:"PST-00010", 
    userid:	"M0010",
    date:"2025/7/20 AM10:45",
...
image: konanImage,     content:'身為一個每年都會朝聖名偵探柯南劇場版的老觀眾，我今年還是乖乖地走進了電影院。這次的劇場版《名偵探柯南：紅之狙擊者》，主打的是懸疑與爆破場面雙強結合，劇情圍繞一樁暗殺事件與新角色的登場。整體來說，我認為劇情節奏是OK的，該緊湊的地方也有緊湊，不過在情感層面的鋪陳稍微弱了一些，柯南與灰原的互動也偏少（有點小失望）。但畫面質感比往年還更有電影感，特別是動作場面和音樂搭配非常有張力。值得一提的是，這次的主題曲我很喜歡，搭配片尾畫面會讓人稍微感動一下。整體而言，雖然不是我心目中的Top 3，但對於系列粉絲來說，還是值得一看。如果你不是很熟柯南系列，也能看懂大部分劇情，但要有心理準備，人物真的很多。今年這部，我給 7.5分/10。'
    ...
    title:"陽明山七星山日出團大推",
    event:"登山",
image: ClimbingImg4,     content:'第二次參加Kevin的登山團了！上次爬大屯山就覺得他很專業，這次七星山也沒讓人失望。凌晨3點集合確實辛苦，但Kevin準備的路線圖和注意事項都很詳細。同團有個阿姨腳力比我還好，真的很佩服！日出時刻大家一起在山頂看台北甦醒的感覺超棒，Kevin還帶了保溫瓶請大家喝熱咖啡。雖然下山後腿軟了一整天，但這種體驗真的無價'
  },
    ...
    title:"德式桌遊工作坊超值體驗！",
    event:"桌遊",
image: nopicture,     content:'在西門町的桌遊咖啡廳參加了6小時的德式桌遊工作坊，真的收穫滿滿！團主阿華是資深玩家，規則講解很清楚，還會分析每個遊戲的策略重點。玩了《農家樂》、《電力公司》、《波多黎各》三款經典，每款都有不同的樂趣。同團的人都很Nice，大家互相討論策略，氣氛很棒。雖然6小時下來有點累，但學到很多，現在已經買了《農家樂》準備跟朋友玩啦！450元真的很值得'
  },
    ...
    title:"狼人殺新手被虐記",
    event:"桌遊",
image: nopicture,     content:'說是新手友善結果完全不是這樣！團主Linda雖然人很好，但同團有幾個老鳥玩家完全不給新手機會，一直用很複雜的進階技巧。我第一輪就被票出去，後面幾乎都在旁邊看戲...雖然有學到一些，但整體體驗不太好。建議團主之後可以把新手和老手分開，或是多控制一下遊戲節奏。不過KTV包廂的環境不錯，飲料零食也夠，就是遊戲體驗需要改進。'
  },
    ...
    title:"攀岩體驗課程推薦！",
    event:"運動",
image: nopicture,     content:'第一次嘗試攀岩就愛上了！<br>團主阿翔是認證教練，安全講習很仔細，裝備檢查也很確實。<br>從最簡單的路線開始，循序漸進讓我們建立信心。同團有個女生一開始很害怕，但在大家鼓勵下最後也成功攻頂，超感動的！<br>3小時的課程安排得很充實，既有挑戰性又很安全。雖然手臂痠痛了幾天，但那種克服恐懼的感覺真的很棒！已經決定要繼續學下去了'
  },
