...
function copyMessage(e) {
  const messageText = e.target
    ...
    .querySelector(".bubble")?.innerText;
  ...
  <section class="chat">
    ...
    <div class="chat-section">
      ...
      <div class="chat-message other">
        <div class="avatar-section">
          <div class="avatar">
            <img
              src="/src/assets/img/chat/user-image1.jpg"
              alt="使用者大頭貼"
            />
          </div>
        ...
        <div class="chat-content-section">
          ...
          <div class="more-options">
            ...
            <ul class="options-menu" :class="{ on: showOptions }">
              ...
              <li>
                <button type="button" @click="openReportModal">檢舉</button>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="chat-message other">
        <div class="avatar-section">
          <div class="avatar">
            <img
              src="/src/assets/img/chat/user-image2.jpg"
              alt="使用者大頭貼"
            />
          </div>
      ...
      <div class="chat-message other">
        <div class="avatar-section">
          <div class="avatar">
            <img
              src="/src/assets/img/chat/user-image3.jpg"
              alt="使用者大頭貼"
            />
          </div>
        ...
        <div class="chat-recommend-card">
          <div class="chat-card">
            ...
            <div class="chat-card-img">
              <img
                src="/src/assets/img/index-img/second-section-img.png"
                alt="聊天是活動推薦卡片裝飾圖"
              />
            </div>
          </div>
      ...
      <div class="chat-message me">
        <div class="avatar-section">
          <div class="avatar">
            <img
              src="/src/assets/img/chat/user-image4.jpg"
              alt="使用者大頭貼"
            />
          </div>
    ...
    <div class="megaphone-box">
      <div class="megaphone-wrap">
        <img
          src="/src/assets/img/chat/megaphone-man.png"
          alt="擴音器人物圖"
          class="person"
        />
        <img
          src="/src/assets/img/chat/megaphone-line.png"
          alt="擴音器線條圖"
          class="lines"
        />
      </div>
    ...
    <div class="chat-key-in-section">
      ...
      <div class="chat-now-btns">
        <button>
          ...
          >
            <path
              d="M19.5 34.5312C27.8015 34.5312 34.5312 27.8015 34.5312 19.5C34.5312 11.1985 27.8015 4.46875 19.5 4.46875C11.1985 4.46875 4.46875 11.1985 4.46875 19.5C4.46875 27.8015 11.1985 34.5312 19.5 34.5312Z"
              fill="#FADA7A"
              stroke="black"
              stroke-width="1.5"
              stroke-linecap="round"
            ...
            />
            <path
              d="M14.625 17.4688C15.7468 17.4688 16.6562 16.5593 16.6562 15.4375C16.6562 14.3157 15.7468 13.4062 14.625 13.4062C13.5032 13.4062 12.5938 14.3157 12.5938 15.4375C12.5938 16.5593 13.5032 17.4688 14.625 17.4688Z"
              fill="black"
            />
            <path
              d="M24.375 17.4688C25.4968 17.4688 26.4062 16.5593 26.4062 15.4375C26.4062 14.3157 25.4968 13.4062 24.375 13.4062C23.2532 13.4062 22.3438 14.3157 22.3438 15.4375C22.3438 16.5593 23.2532 17.4688 24.375 17.4688Z"
              fill="black"
            />
            <path
              d="M25.1291 23.1562C24.5586 24.1443 23.738 24.9648 22.75 25.5352C21.7619 26.1057 20.641 26.406 19.5001 26.406C18.3592 26.406 17.2383 26.1057 16.2502 25.5352C15.2621 24.9648 14.4416 24.1443 13.8711 23.1562"
              stroke="black"
              stroke-width="1.5"
              stroke-linecap="round"
              stroke-linejoin="round"
