...
image: '@/assets/img/article/movie_konan.jpg',
 ...
 {postId:"PST-000004", 
   ...
   {postId:"PST-000006", 
    ...
    event:"運動",
    image:"@/assets/img/article/movie_konan.jpg",
    content:'研究所生活忙碌到快忘了什麼叫運動，還好這陣子朋友推薦我用 JOIKA 找運動團，意外發現每週都有固定的籃球揪團，地點就在師大體育館，超方便！一開始還有點擔心氣氛會不會太競技，但其實大家都滿有共識，屬於「能認真打、也能放鬆玩」的那種風格。報名制度也很清楚，額滿就關團，不會現場一堆人卡位。<br>這次打的是全場 5v5，隊友配合默契不錯，而且完全不會有那種「只傳給朋友」的現象，大家互傳互動滿流暢。中場休息時也會聊一下各自怎麼知道這個揪團的，才知道有不少人其實是工程師或研究員，甚至有兩個是第一次參加。蠻推薦這種半固定的揪團，適合想保持運動習慣又不想太競爭的朋友。有興趣的人可以在活動分類裡搜尋「每週籃球週五夜場」，真的值得試一次！'
  },{postId:"PST-000007", 
    userId:	"M0007",
    ...
    event:"聚餐",
    image:"@/assets/img/article/movie_konan.jpg",
    content:'走進這間藏身巷弄的老屋餐廳，像是穿越了時光隧道。斑駁的木門輕輕推開，陽光從窗櫺灑落，斑駁光影在桌面上跳動，像是在講述一段被時間遺忘的故事。座位旁擺放著老式收音機和幾本泛黃的書籍，空氣中混合著淡淡的咖啡香與陳年的木頭味。這裡的招牌手作鹹派，是一場味覺的旅行。酥脆的派皮裡包裹著溫潤的奶油和香濃的菠菜，搭配一杯微酸的黑咖啡，簡單卻滿足。作為攝影師，最愛捕捉這種光影與空間的細膩變化。旅途中偶然發現的這片靜謐，是讓心靈得以喘息的港灣。<br>若你也喜歡細細品味生活，不妨來這裡坐坐，感受老屋的溫度，聽聽時間的聲音。'
  },
  {postId:"PST-000008", 
    userId:	"M0008",
    ...
    event:"水上活動",
    image:"@/assets/img/article/movie_konan.jpg",
    content:'身為土生土長的台南人，長年習慣在海邊散步，這次參加JOIKA組織的淨灘活動，才真正感受到保護環境的重要性。沿著台南安平海岸線，我們一群志同道合的朋友，拿著手套和垃圾袋，仔細地將塑膠瓶、菸蒂、包裝紙等垃圾一一撿起。看著平時美麗的海岸線被這些不起眼的垃圾侵蝕，心裡不免有些沉重。作為設計師，我也在想，或許我們可以用創意來提醒更多人愛護海洋，比如設計更友善環境的包裝，或是創作宣導海洋保護的插畫。淨灘不只是撿垃圾，更是一場與大自然的對話，提醒自己從生活小事做起，才能守護我們共有的家園。很感謝JOIKA提供這樣的平台，讓台南人能凝聚力量，一起為環境盡一份力。期待未來還有更多這樣有意義的活動，一起加入吧！'
  },
      {postId:"PST-00010", 
    userId:	"M0010",
    date:"2025/7/20 AM10:45",
    ...
    event:"登山",
    image:"@/assets/img/article/movie_konan.jpg",
    content:'這次去爬了附近的一座山，路線還算簡單。<br>天氣還行，沒下雨也沒太陽。<br>走路的時候沒什麼特別的感覺，<br>也沒看到什麼特別的風景，偶爾聽到幾隻鳥叫聲。<br>休息的地方挺普通，沒什麼特別好說的。<br>帶的水和點心都吃完了。<br>整體來說，就是一次平淡無奇的登山經驗。'
  },
        {postId:"PST-00011", 
    userId:	"M0011",
    date:"2025/7/20 AM10:45",
    ...
    event:"登山",
    image:"@/assets/img/article/movie_konan.jpg",
    content:'第二次參加Kevin的登山團了！上次爬大屯山就覺得他很專業，這次七星山也沒讓人失望。凌晨3點集合確實辛苦，但Kevin準備的路線圖和注意事項都很詳細。同團有個阿姨腳力比我還好，真的很佩服！日出時刻大家一起在山頂看台北甦醒的感覺超棒，Kevin還帶了保溫瓶請大家喝熱咖啡。雖然下山後腿軟了一整天，但這種體驗真的無價'
  },
    ...
    event:"桌遊",
    image:"@/assets/img/article/movie_konan.jpg",
    content:'在西門町的桌遊咖啡廳參加了6小時的德式桌遊工作坊，真的收穫滿滿！團主阿華是資深玩家，規則講解很清楚，還會分析每個遊戲的策略重點。玩了《農家樂》、《電力公司》、《波多黎各》三款經典，每款都有不同的樂趣。同團的人都很Nice，大家互相討論策略，氣氛很棒。雖然6小時下來有點累，但學到很多，現在已經買了《農家樂》準備跟朋友玩啦！450元真的很值得'
  },
    ...
    event:"桌遊",
    image:"@/assets/img/article/movie_konan.jpg",
    content:'說是新手友善結果完全不是這樣！團主Linda雖然人很好，但同團有幾個老鳥玩家完全不給新手機會，一直用很複雜的進階技巧。我第一輪就被票出去，後面幾乎都在旁邊看戲...雖然有學到一些，但整體體驗不太好。建議團主之後可以把新手和老手分開，或是多控制一下遊戲節奏。不過KTV包廂的環境不錯，飲料零食也夠，就是遊戲體驗需要改進。'
  },
    ...
    event:"運動",
    image:"@/assets/img/article/movie_konan.jpg",
    content:'第一次嘗試攀岩就愛上了！<br>團主阿翔是認證教練，安全講習很仔細，裝備檢查也很確實。<br>從最簡單的路線開始，循序漸進讓我們建立信心。同團有個女生一開始很害怕，但在大家鼓勵下最後也成功攻頂，超感動的！<br>3小時的課程安排得很充實，既有挑戰性又很安全。雖然手臂痠痛了幾天，但那種克服恐懼的感覺真的很棒！已經決定要繼續學下去了'
  },
