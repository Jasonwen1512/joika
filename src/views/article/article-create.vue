...
const props = defineProps({
  ...
  plugins: { type: [String, Array], default: 'quickbars emoticons table autoresize image' },
  toolbar: { type: [String, Array], default: 'bold italic underline strikethrough | fontsizeselect | forecolor backcolor | alignleft aligncenter alignright alignjustify | bullist numlist | outdent indent blockquote | undo redo | image | removeformat | table | emoticons' },
});

const emit = defineEmits(['update:modelValue']);

// --- 圖片上傳處理邏輯 (保持不變) ---
const uploadImageAndGetUrl = (blobInfo) => new Promise((resolve, reject) => {
